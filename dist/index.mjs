import { reactive, defineComponent, ref, onMounted, onBeforeUnmount, h, createApp } from 'vue';
    ...
    render() {
        ...
        const renderMenuItem = (item, index) => {
            ...
            if (item.submenu && this.itemRefs.get(index)) {
                ...
                if (parentRef) {
                    children.push(h(SubmenuComponent, {
                        items: item.submenu,
                        parentRef: parentRef,
        ...
        return h('div', {
            ...
            onMouseenter: this.handleSubmenuMouseEnter,
            onMouseleave: this.handleSubmenuMouseLeave
        }, h('div', { class: 'context-menu-items' }, this.items.map((item, index) => renderMenuItem(item, index))));
    }
});
...
export { ContextMenu, index as default, useContextMenu };
